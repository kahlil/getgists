...
(function( $, window, document, undefined ) {
    ...
    document.write  = function( str ) {
        ...
        script = document.querySelector( 'script[src="https://gist.github.com/' + id + '.js"]' );
    ...
    Plugin.prototype = {
        ...
        fetchGists: function( options, success ) {
            ...
            var path, filteredData, slicedData;
            ...
            $.ajax({
                ...
                success: $.proxy( function( data, textStatus, jqXHR ) {
                    filteredData = $.grep( data, $.proxy( function( elementOfArray, indexInArray ) {
                        return this.filter( options, elementOfArray );
                    }, this ));
                    slicedData = filteredData.slice( 0, options.count );
                    success( slicedData );
                }, this ),
        ...
        embed: function( ) {
            ...
            this.fetchGists( this.options, $.proxy( function ( list ) {
                ...
                list.forEach( $.proxy( function ( el ) {
                    ...
                    elem = ( this.options.outputElem === 'li' ) ? $('<li>') : $('<div>');
